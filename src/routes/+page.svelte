...
<div class="inner">
    <a href="https://ngl.link/n.o.e.11" on:click={handleClick} target="_blank">
        ...
        NGL.Link</a>
    <a href="https://github.com/NoelJacob" target="_blank">
        ...
        Github</a>
    <a href="https://pinterest.com/noeljacob91/_saved" target="_blank">
        ...
        Pinterest</a>
    <a href="https://open.spotify.com/user/noeljacob" target="_blank">
        ...
        Spotify</a>
    <a href="https://www.linkedin.com/in/noel-jacob" target="_blank">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
